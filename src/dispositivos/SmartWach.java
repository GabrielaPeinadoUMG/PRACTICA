 ...
 * @author HP
 */
public class SmartWach extends Crear_Dispo{
  private int Correo_Electronico;
  private int Nombre_Dispositivo;
  private int Visible_Conexion;
  
  public SmartWach(int Correo_Electronico, int Nombre_Dispositivo, int Visible_Conexion, String Computadora_Portatil, String Tablet,String SmartWatch, String Smartphone,String Auriculares_Inalambrico ){ 
